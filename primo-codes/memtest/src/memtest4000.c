...
void redrawScreen() {
    ...
    printf( "E:%-2X %-2X %-2X %-2X %-2X %-2X %-2X %-2X - - - - - - - -\r", err_bits[ 3 ], err_bits[ 6 ], err_bits[ 7 ], err_bits[ 0 ], err_bits[ 1 ], err_bits[ 5 ], err_bits[ 4 ], err_bits[ 2 ] );
