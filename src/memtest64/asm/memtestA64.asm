...
RESTART:
    ...
    LD HL, $4400
    LD DE, $A000             ; E400-4000
;    LD HL, $F600
;    LD DE, $0400             ; E400-4000
    LD C, 0                  ; Error counter
    CALL SHOW_STATUS
CHECK_RAM:
;    LD ($E800), A
    LD B, 0
...
END_SCREEN_OK:    db  CR_LF,"All memories are OK",CR_LF,"Restar: Return",0
END_SCREEN_ERROR: db  CR_LF,"Error(s) found",CR_LF,"Restar: Return",0
